...
- With Chat GPT ( Http API with OpenAPI Specs + OAuth )
- With Dify ( Http API with OpenAPI Specs + Dify Tool )
- With Claude Desktop ( Custom MCP Server for MSKM )
- Dev Your AI APPs ( SK / OpenAI API with MSKM WebClient )
...
1. MSKM with GPTs
1. MSKM with Dify
1. MSKM with Claude Desktop ( MCP Server )
- use MCPSharp
- use MCP official csharp-sdk